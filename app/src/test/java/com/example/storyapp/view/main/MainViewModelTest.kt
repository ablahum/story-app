...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        val dummyStory = DataDummy.generateDummyItemResponse()
        val data: PagingData<ListStoryItem> = ItemPagingSource.snapshot(dummyStory)
...
class ItemPagingSource : PagingSource<Int, LiveData<List<ListStoryItem>>>() {
    companion object {
